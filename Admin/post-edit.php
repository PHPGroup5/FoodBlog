                    ...
                    <li class="list-group-item">
                        <form action="updatePost.php" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="title" id="title" required="required" placeholder="Title" value="<?php echo $row['title']?>">
                            <input type="hidden" class="form-control" name="oldtitle" id="title" required="required" placeholder="Title" value="<?php echo $row['title']?>">
                            </div>
...
<script>
    $(document).ready(function () {
        var Str = <?php echo json_encode($content); ?>;
