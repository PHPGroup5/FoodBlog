...
<div class="login-card"><img class="profile-img-card" src="assets/img/avatar_2x.png">
    ...
    <?php } ?>class="form-control" type="email" id="inputEmail" required="" placeholder="Email address" autofocus=""
               name="email">
        <input<?php if (isset($_GET["msg"]) && $_GET["msg"] == 'failed') { ?>
        style= "border: #FF0000 solid 1px;"
        ...
        <?php if (isset($_GET["msg"]) && $_GET["msg"] == 'failed') { ?>
            <div>
                <span style="color:#a71d2a ; font-size: x-small; text-shadow: #a71d2a;">
                    <img src="assets/img/exclamation-triangle-solid.svg" style ="width: 20px; height: 20px;">Wrong password .Try again.</span></div>
        <?php } ?>
        <div class="checkbox">
