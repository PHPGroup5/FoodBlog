            ...
            while ($row = mysqli_fetch_assoc($result)):
                ...
                <div class="col-sm-6 col-md-4 portfolio-item">
                    <a class="portfolio-link" href="categoryDetail.php?id=<?php echo $row['id'] ?>">
                        ...
                        <img style="width: 400px;height: 200px;" class="img-fluid " src="../Admin/assets/img/category/<?php echo $row['photo'] ?>"></a>
                    <div class="portfolio-caption" style="background-color: #F8F9FC;">
