            ...
            <div class="row">
                            ...
                            <div class="back-imagia">
                                <div class="d-flex align-items-center h-100 px-3">
                                    <div>
                                        ...
                                        <p class="text-center">I am a member of PHP Group-5 and I love foods! </p>
                                    </div>
                                </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card-container-imagia">
                        <div class="card-imagia">
                            <div class="front-imagia">
                                <div class="cover-imagia"><img class="w-100" alt="" src="assets/img/Astons.png"></div>
                                <div class="user-imagia"><img class="rounded-circle m-2 img-fluid" alt=""
                    ...
                    <div class="card-container-imagia">
                        <div class="card-imagia">
                            <div class="front-imagia">
                                ...
                                <div class="user-imagia"><img class="rounded-circle m-2 img-fluid" alt=""
                                                              src="assets/img/About/pt5.png"></div>
                                <div class="py-1 px-3 text-center">
                                    <h3 class="text-capitalize m-0">Thet Su Su Kyaw</h3>
                                    <p class="text-secondary mb-3">Front End and Back End Developer</p>
                                    <p><em>Hi I am Thet Su.Taste the Joy has since grown into a destination for millions
                                            of passionate, curious, and hungry readers around the world. </em></div>
                            ...
                            <div class="front-imagia">
                                ...
                                <div class="py-1 px-3 text-center">
                                    ...
                                    <p><em>Hi I am Hay Thi.Taste the joy is a favorite of industry pros for finding out
                                            what's opening where,and how it's all going down.A delicious food blog
                                            celebrating life around the table. </em></div>
